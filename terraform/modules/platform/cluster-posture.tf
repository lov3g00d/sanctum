# App-namespace posture for nimbus, delivered as manifests: the PSA-restricted
# namespace, default-deny + DNS-baseline NetworkPolicies, least-privilege RBAC, and
# the compute ResourceQuota and LimitRange. The platform owns the nimbus namespace;

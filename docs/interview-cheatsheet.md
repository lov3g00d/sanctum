...
proxied records hide your origin IP. `chambers/aws-eks/terraform/modules/cloudflare/` shows it as IaC.
...
**Monitoring** (see `chambers/aws-eks/terraform/modules/platform/config/` and `shared/charts/podinfo/`)
